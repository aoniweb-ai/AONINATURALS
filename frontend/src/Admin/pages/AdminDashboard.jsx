      ...
      >
        ...
        >
              ...
              >
                {recentOrders?.map((item) => (
                  <motion.tr
                    ...
                    onClick={() =>
                      navigate(
                        `/${import.meta.env.VITE_ADMIN_POST_URI}/orders/details/${item.order_id}`,
                      )
                    }
                  ...
                  >
                    ...
                    <td className="border-none">
                      <span
                        className={`px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider ${statusColor(item.status)}`}
                      >
                        {item?.status}
                      </span>
                    </td>
          ...
          <p className="text-center p-4 text-gray-400">
            {recentOrders?.length <= 0 && "No orders here"}
          </p>
          ...
          <div className="p-4 bg-gray-50/50 border-t border-gray-50 text-center">
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              onClick={() =>
                navigate(`/${import.meta.env.VITE_ADMIN_POST_URI}/orders`)
              }
