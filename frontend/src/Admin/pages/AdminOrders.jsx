    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        >
          ...
          {/* QUICK STAT */}
          <motion.div variants={itemVariants} className="hidden sm:flex gap-4">
            <div className="bg-white p-4 px-8 rounded-4xl shadow-sm border border-slate-100 flex items-center gap-4 hover:shadow-md transition-shadow cursor-default">
            ...
            {!orders || loader ? (
              ...
              >
                ...
                <p className="text-slate-500 mt-2 max-w-sm mx-auto font-medium">
                  ...
                  <span className="text-slate-800">{search}</span>" in the{" "}
