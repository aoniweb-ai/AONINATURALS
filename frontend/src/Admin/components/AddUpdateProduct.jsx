...
const AddUpdateProduct = () => {
  ...
  const {adminProduct_addUpdate, editProduct, setEditProduct} = useAdminBear(state=>state);
  ...
  return (
    ...
    <dialog  className="modal" role="dialog">
        <form onSubmit={handleSubmit(formHandler)} className="w-full flex justify-center">
            <div className="modal-box w-full max-w-4xl relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    />
                    <input className="input input-bordered w-full" placeholder="Price (rs)" 
                ...
                {step === 2 && (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <input className="input input-bordered w-full" placeholder="Discount (%)" 
                        {...register("discount",{required:false})}
                    />
                    <input className="input input-bordered w-full" placeholder="Extra Discount (%)" 
                        {...register("extra_discount",{required:false})}
                    />
                    <input className="input input-bordered w-full" placeholder="COD Charges (rs)" 
                ...
                {step === 4 && (
                    <div className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            />
                            <label htmlFor="soldCount" className="flex items-center gap-3 p-3 bg-base-200 rounded-lg">
                        ...
                        <div>
                            ...
                            <div className="space-y-3">
                                ...
                                <input
                                    ...
                                    onChange={(e) =>
                                    setImages((val) => [...val, ...e.target.files])
                                    }
                                />
                                ))}
                            </div>
                ...
                <div className="modal-action flex justify-between">
                    ...
                    <button className={`btn ${loader && 'btn-disabled'} btn-success`}>
