...
import CenterLoader from "../../../components/CenterLoader"; // Assuming component exists
import { useNavigate } from "react-router-dom";
import { formatDateTime } from "../../../utils/formatDateTime";

const UserAccount = () => {
  const { user, userProfileUpdate, userAddressUpdate, userLogout } = useUserBear((state) => state);
  ...
  const editHandler = async (data) => {
    try {
      // Logic Fix: Check if BOTH fields are unchanged
    ...
    <section className="min-h-screen bg-[#f9fafb] font-sans py-10">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <div className="mb-10 text-center sm:text-left">
          ...
          <p className="text-gray-500 mt-2">Manage your profile, address, and preferences.</p>
        </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-sm border border-gray-100 relative overflow-hidden">
                <div className="flex flex-col sm:flex-row gap-6 items-start sm:items-center">
                    ...
                    {/* Info Form */}
                    <form onSubmit={handleSubmit(editHandler)} className="flex-1 w-full">
                        <div className="flex justify-between items-start mb-4">
                            <div>
                                <h2 className="text-lg font-bold text-gray-900">Personal Information</h2>
                                <p className="text-xs text-gray-400">Update your photo and personal details.</p>
                            </div>
                            ...
                            {!editProfile ? (
                                ...
                                <div className="flex gap-2">
                                    <button 
                                        type="button" 
                                        onClick={() => { setEditProfile(false); reset(); }}
                                    ...
                                    >
                                        {profileLoader ? <span className="loading loading-spinner loading-xs"></span> : <Check size={18} />}
                                    </button>
                                </div>
                            )}
                        </div>
                                ...
                                <div className="sm:col-span-2">
                                    {editProfile ? (
                                        ...
                                        <p className="flex items-center gap-2 font-semibold text-gray-900">
                                            <Phone size={14} className="text-gray-400"/> {user.phone || "Not added"}
                                        </p>
                                    )}
                                </div>
                            </div>
                ...
                <div className="flex justify-between items-start mb-6">
                     <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-400">Used for shipping orders</p>
                        </div>
                     </div>
                     {!editAddress && (
                        <button 
                    ...
                    {!editAddress ? (
                        ...
                        <div className="space-y-3 animate-in fade-in zoom-in-95 duration-200">
                            ...
                            <div className="flex justify-end gap-2">
                                <button 
                                    type="button"
                                    onClick={() => { setEditAddress(false); reset({ address: user.address }); }}
            ...
            <div className="bg-white rounded-3xl p-2 shadow-sm border border-gray-100">
                ...
                >
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-400">Track current & past orders</p>
                        </div>
                    </div>
                ...
                <div className="group flex items-center justify-between p-4 hover:bg-gray-50 rounded-2xl cursor-pointer transition-all">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h3 className="font-bold text-gray-900 text-sm">Login & Security</h3>
